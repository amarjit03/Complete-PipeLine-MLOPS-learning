...
def main():
    try:
        # Load parameters from the YAML file (use default params if file not found)
        params = load_params(params_path='params.yaml') if os.path.exists('params.yaml') else {'data_ingestion': {'test_size': 0.2}}
        ...
        save_data(train_data, test_data, save_path='./data')
